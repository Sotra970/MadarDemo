...
public abstract class GetLocationFragment extends AddOrderBaseFragment implements OnMapReadyCallback  {
    ...
    protected Marker currentPosIcon;
...
//    GetLocationInterface getLocationInterface ;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (v == null) {
            v = inflater.inflate(R.layout.fragment_reciving_place1, container, false);
...
//                    update_place_req();
    ...
    ArrayList<FavLocationModel> favLocationModels  = new ArrayList<>() ;
    ...
    private void getDefaultFav() {
        ...
        get_favs(new FavFetch() {
            ...
            }else mapDefaultMoveCameraAction(null,new LatLng( gpsTracker.getLatitude() , gpsTracker.getLongitude()));}
        },false);
    }
...
//
   ...
   protected void onFetchLocationFinish(AddressDetailsResponse.AddressDetailsData data , LatLng latLng){
    ...
    void search_locations (){
        ((FragmentSwitchActivity) getActivity()).show_favs();
    }
    ...
    public void onFavClicked(FavLocationModel favLocationModel) {
        manual =true ;
...
//                    }
                    ...
                    if (favLocationModel.getLongitude().equals(child.getLongitude()+"") && favLocationModel.getLatitude().equals(child.getLatitude()+"")){
                        Log.e("fav_loc_comp" , "exist") ;
                        favPosListener.onFetch(true);
                        return;
                    }
    ...
    void addd_fav_address(){
        Log.e("add_fav" , "addd_fav_address");

        if (fav_exist){
            Log.e("add_fav" , "fav_exist");
            return;
        }
        ...
        if (favLocationModel == null){
            Log.e("add_fav" , "favLocationModel:null");
            return;
        }
        if (favLocationModel.getDetails() == null){
            Log.e("add_fav" , "favLocationModel.getDetails:null");
            return;
        }
